defmodule Bridge.Factory do
  ...
  This module provides factory functions to create realistic test data for all
  ...
  """
  def tag_translation_factory do
  ...
  def card_template_factory do
    ...
    {name, fields} = Enum.random(template_types)
  ...
  """
  def card_factory do
    card_template = build(:card_template)
  ...
  """
  def template_mapping_factory do
    use_cases = ["flashcard", "study_mode", "quiz", "review", "practice"]
    use_case = Enum.random(use_cases)
  ...
  """
  def vocabulary_list_factory do
    list_topics = [
      "basic-vocabulary",
      "advanced-words",
      "business-terms",
  ...
  """
  def vocabulary_list_card_factory do
    %VocabularyListCard{
      vocabulary_list: build(:vocabulary_list),
      card: build(:card)
    }
  end
